...
$(document).ready(function() {
	document.getElementsByClassName("record")[0].innerHTML = '<div class="level"><div class="audiolevel"></div></div>'
	document.getElementsByClassName("playback")[0].innerHTML = '<div class="level"><div class="progress"></div></div>'
});
